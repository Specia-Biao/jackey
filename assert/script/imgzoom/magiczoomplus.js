...
(function (a) {
    ...
    a.FX.Slide = new a.Class(a.FX, {
        options: {mode: "vertical"}, init: function (d, c) {
            this.el = $mjs(d);
            this.options = a.extend(this.$parent.options, this.options);
            this.$parent.init(d, c);
            this.wrapper = this.el.j29("slide:wrapper");
            this.wrapper = this.wrapper || a.$new("DIV").j6(a.extend(this.el.j19s("margin-top", "margin-left", "margin-right", "margin-bottom", "position", "top", "float"), {overflow: "hidden"})).enclose(this.el);
            ...
            var g = this.el.j5(this.margin).j17(), f = this.wrapper.j5(this.layout).j17(), c = {}, i = {}, d;
...
var MagicZoomPlus = (function (g) {
        ...
        construct: function (k, j) {
            ...
            if (!this.z47) {
                ...
                if (g.j21.trident4) {
                    ...
                    l.src = "javascript:''";
                    l.j6({left: "0px", top: "0px", position: "absolute", "z-index": -1}).frameBorder = 0;
            ...
            var m = /tr|br/i, e = /bl|br|bc/i, j = /bc|tc/i, l = null;
            ...
            g.$A(document.getElementsByTagName("A")).j14(function (n) {
                if (j.test(n.rel)) {
                    ...
                    n.j6({outline: "0", display: "inline-block"});
            ...
            if (this.options.selectorsEffect != "false") {
                ...
                if ("pounce" == this.options.selectorsEffect) {
                    ...
                    l.self.j6({opacity: 0, position: "absolute", left: "0px", top: "0px"})
                }
                e = function () {
                    var E = {}, G = {}, F = {}, H = null;
                    if ("pounce" == this.options.selectorsEffect) {
            ...
            if (e = this.c.j29("thumb")) {
                this.z4.self.j6({cursor: (e._o.disableExpand) ? "move" : ""})
            }
            ...
            if (!this.options.opacityReverse && !this.options.rightClick) {
                ...
                if (this.z4.z42) {
                    ...
                    j.unselectable = "on";
                    this.z4.z42 = $mjs(this.z4.self.appendChild(j)).j6({position: "absolute", zIndex: 5})
                }
                if (this.options.opacityReverse) {
                    this.z4.self.j23(1)
                } else {
            ...
            var r, n, k, j, p, o, m, l, e = this.options, s = this.z4;
            r = s.width / 2;
            n = s.height / 2;
            ...
            var j = this.t13(5), e = this.z7.self.j9(), n = this.options.zoomPosition, m = this.z47,
                k = this.options.zoomDistance, q = m.self.j7(), p = e.top + m.initTopPos, l = e.left + m.initLeftPos,
                o = {x: m.initLeftPos, y: m.initTopPos};
            if ("left" == n || "right" == n) {
            ...
            k = k || 0;
            var j = (g.j21.touchScreen) ? {width: window.innerWidth, height: window.innerHeight} : $mjs(window).j7(),
                e = $mjs(window).j10();
            return {left: e.x + k, right: e.x + j.width - k, top: e.y + k, bottom: e.y + j.height - k}
        }, activate: function (e) {
    ...
    var d = new g.Class({
        self: null,
        ready: false,
        options: {width: -1, height: -1, onload: g.$F, onabort: g.$F, onerror: g.$F},
        width: 0,
        height: 0,
        nWidth: 0,
        nHeight: 0,
        ...
        init: function (k, j) {
            ...
            var e = this.self = $mjs(k) || g.$new("img", {}, {
                ...
                height: 10,
                overflow: "hidden"
            }).j32(g.body)).j30("new", true), l = function () {
                if (this.isReady()) {
    ...
    var b = {
        version: "v2.1.0.rc16", options: {}, lang: {}, start: function (m) {
            this.thumbs = $mjs(window).j29("magicthumb:items", $mjs([]));
            var l = null, j = null, k = $mjs([]),
    ...
    var a = new g.Class({
        ...
        _lang: {buttonPrevious: "Previous", buttonNext: "Next", buttonClose: "Close"},
        thumbs: [],
        t29: null,
        r: null,
        id: null,
        ...
        t28: [],
        cbs: {
            previous: {index: 0, title: "buttonPrevious"},
            next: {index: 1, title: "buttonNext"},
            close: {index: 2, title: "buttonClose"}
        },
        ...
        init: function (e, j) {
            ...
            if ((" " + this.r.className + " ").match(/\s(MagicThumb|MagicZoomPlus)\s/)) {
                this.r.j6({position: "relative", display: (g.j21.gecko181 || g.j21.presto) ? "block" : "inline-block"});
                if (this._o.disableExpand) {
                ...
                if (!g.j21.touchScreen) {
                    ...
                    this.r.je1("touchstart", function (k) {
                        ...
                        this.r.j30("event:lastTap", {id: k.targetTouches[0].identifier, ts: l})
                    }.j16(this));
                    this.r.je1("touchend", function (l) {
                        var m = g.now(), k = this.r.j29("event:lastTap");
                ...
                if (!g.j21.touchScreen) {
                    this.r.j30("j24:hover", function (n) {
                        $mjs(n).stop();
                        var l = this.j29("thumb"), o = l.t16(l.t27 || l.id), k = (l.hint),
        ...
        swap: function (e, l) {
            ...
            this.state = "updating";
            e.state = "updating";
            var x = this.t16(this.t27 || this.id), n = x.r.byTag("img")[0], u, k = {}, w = {}, m = {}, q, s, j, p, r, y,
                v, o = null;
            u = function (z, A) {
            ...
            if (!l) {
                ...
                if ("pounce" == this._o.selectorsEffect) {
                    ...
                    e.z7.self.j6({position: "absolute", "z-index": 1, left: "0px", top: "0px"}).j32(x.r, "top").j23(0);
                    w = {opacity: [0, 1]};
                ...
                new g.PFX([x.r, e.z7.self, (o || n)], {
                    ...
                    onComplete: function (z, A, B) {
                        ...
                        A.j33().j6({visibility: "visible"});
                        this.z7.self.j32(z, "top").j6({position: "static", "z-index": 0});
                        u.call(this, z, B)
                    }.j24(e, x.r, n, this)
                }).start([m, w, k])
            } else {
        ...
        update: function (e, m, j) {
            var n = null, l = this.t16(this.t27 || this.id);
            try {
        ...
        z29: function () {
            ...
            var e = this.z3.j32(g.body).j7(), k = this.t14(e, j);
            this.z3.j6({top: k.y, left: k.x}).show()
        },
        setupHint: function () {
            var o = /tr|br/i, e = /bl|br|bc/i, j = /bc|tc/i, n = null, k = this.t16(this.t27 || this.id), m = null;
        ...
        t2: function () {
            if (this.params.thumbnail) {
                this.z7 = new d(this.params.thumbnail, {onload: this.setupContent.j24(this, this.params.content)})
            } else {
                this._o.hint = false;
        ...
        setupContent: function (e) {
            ...
            switch (this.media) {
                ...
                default:
                    this.z1 = new d(e, {
                        width: this.size.width, height: this.size.height, onload: function () {
        ...
        t1: function () {
            var o = this.content, p = this.size;
            if (!o) {
                return false
            }
            ...
            if ("undefined" !== typeof(j)) {
                ...
                m.j6({top: p.height - m.j7().height - 5});
            ...
            if (g.j21.trident4) {
                this.overlapBox = g.$new("DIV", {}, {
                    ...
                    width: "100%",
                    height: "auto"
                }).append(g.$new("IFRAME", {src: 'javascript: "";'}, {
                    width: "100%",
                    height: "100%",
                    border: "none",
                    display: "block",
        ...
        t4: function (v) {
            var u = null, e = this._o.captionSource, m = this.r.byTag("img")[0], l = this.z1, r = this.size;
            ...
            function q() {
                var A = this.t25.j7(), z = this.t25.j19s("paddingTop", "paddingLeft", "paddingRight", "paddingBottom"),
                    y = 0, x = 0;
            ...
            if (this.captionText) {
                var j = {left: 0, top: "auto", bottom: 0, right: "auto", width: "auto", height: "auto"};
                ...
                this.t25.j30("slide", new g.FX.Slide(this.t25, {
                    duration: this._o.captionSpeed, onStart: function () {
        ...
        t5: function () {
            ...
            $mjs($mjs(this._o.buttonsDisplay.replace(/\s/ig, "").split(",")).filter(function (k) {
                ...
                k = k.j26();
                var m = g.$new("A", {title: this._lang[this.cbs[k].title], href: "#", rel: k}, {
                    display: "block",
                    "float": "left"
                }).j32(this.t26), l = (l = m.j5("width")) ? l.j17() : 0, q = (q = m.j5("height")) ? q.j17() : 0;
                m.j6({
                    "float": "left",
                    position: "relative",
                    outline: "none",
                ...
                if (g.j21.trident4) {
                    ...
                    m.j6({backgroundImage: "none", overflow: "hidden", display: "block"});
                    var n = '<mt_vml_:rect stroked="false"><mt_vml_:fill type="tile" src="' + e + '"></mt_vml_:fill></mt_vml_:rect>';
                    m.insertAdjacentHTML("beforeEnd", n);
                    $mjs(m.firstChild).j6({display: "block", width: (l * 3) + "px", height: q * 2});
                    m.scrollLeft = (this.cbs[k].index * l) + 1;
                    m.scrollTop = 1;
                    m.j30("bg-position", {l: m.scrollLeft, t: m.scrollTop})
                }
            }, this)
        },
        t6: function (e) {
            ...
            $mjs(g.$A(g.doc.byTag("A")).filter(function (l) {
                ...
                $mjs(m).j30("j24:replace", function (r, n) {
                    var p = this.j29("thumb"), o = n.j29("thumb"), q = p.t16(p.t27 || p.id);
                ...
                if (m.href != this.z1.self.src) {
                    ...
                    if (l) {
                        ...
                        new a(m, g.extend(g.detach(this._o), {
                            initializeOn: "load",
                            group: this.group
                        }), {thumbnail: m.rev, t27: this.id, index: j + k})
                    }
                } else {
                    this.selector = m;
                    m.j30("thumb", this);
                ...
                m.j6({outline: "none"}).j2("MagicThumb-swap");
                this.t28.push(m)
            }, this)
        },
        t7: function () {
            ...
            if (!g.j21.touchScreen) {
                ...
                this.t23.je1("touchstart", function (m) {
                    ...
                    this.t23.j30("event:lastTap", {id: m.targetTouches[0].identifier, ts: o})
                }.j16(this));
                this.t23.je1("touchend", function (o) {
                    var p = g.now(), m = this.t23.j29("event:lastTap");
        ...
        t8: function () {
            ...
            this.t31 = new g.FX(this.t22, {
                ...
                onComplete: function () {
                    ...
                    this.t22.j6({top: -10000}).j32(this.t29);
                    this.state = "inz30"
                }.j24(this)
            });
            if (g.j21.trident4) {
                this.t30.options.onBeforeRender = this.t31.options.onBeforeRender = function (l, e, m, k) {
                    var j = k.width + e;
                    this.overlapBox.j6({width: j, height: Math.ceil(j / l) + m});
                    if (k.opacity) {
        ...
        expand: function (w, q) {
            ...
            var z = this.t16(this.t27 || this.id).r.j29("thumb"), e = (z.z7) ? z.z7.self.j9() : z.r.j9(),
                v = (z.z7) ? z.z7.self.j8() : z.r.j8(), x = ("fit-screen" == this._o.expandSize) ? this.resize() : {
                ...
                }, r = {width: x.width + this.t22.j29("padX"), height: x.height + this.t22.j29("padY")}, s = {},
                l = [this.t22.j19s("paddingTop", "paddingLeft", "paddingRight", "paddingBottom"), this.t22.j29("padding")],
                k = {width: [e.right - e.left, x.width]};
            ...
            switch (this._o.expandPosition) {
                ...
                default:
                    if ("fit-screen" == this._o.expandSize) {
                        ...
                        r = {width: x.width + this.t22.j29("padX"), height: x.height + this.t22.j29("padY")};
                        k.width[1] = x.width
                    }
            ...
            if (this.t26) {
                g.$A(this.t26.byTag("A")).forEach(function (A) {
                    ...
                    if (g.j21.trident4) {
                        ...
                        p[1] = "0px";
                        A.j6({"background-position": p.join(" ")})
                    }
                });
                var m = g.$A(this.t26.byTag("A")).filter(function (p) {
                    return "previous" == p.rel
                })[0], o = g.$A(this.t26.byTag("A")).filter(function (p) {
                    return "next" == p.rel
                })[0], u = this.t19(this.group), n = this.t20(this.group);
                if (m) {
        ...
        restore: function (e, n) {
            ...
            if (e && "expand" != this._o.slideshowEffect) {
                ...
                var l = this.t16(this.t27 || this.id).r.j29("thumb"), q = (l.z7) ? l.z7.self : l.r;
        ...
        t10: function (j, l) {
            ...
            j = j || false;
            l = l || false;
            var k = n.j29("cb:t32"), e = {};
            if (!k) {
                n.j30("cb:t32", k = new g.FX(n, {transition: g.FX.Transition.linear, duration: 250}))
            } else {
                k.stop()
            }
            if (l) {
        ...
        cbHover: function (m) {
            ...
            if (g.j21.trident4) {
                ...
                k.j6({"background-position": j.join(" ")})
            }
        },
        cbClick: function (k) {
        ...
        t11: function (j) {
            ...
            if (!k) {
                ...
                if (g.j21.trident4) {
                    l.append(g.$new("IFRAME", {src: 'javascript:"";'}, {
                        width: "100%",
                        height: "100%",
                        display: "block",
                        filter: "mask()",
                ...
                g.doc.j30("bg:t32", k = new g.FX(l, {
                    ...
                    onStart: function (n) {
                        if (n) {
                            this.j6(g.extend(g.doc.j12(), {position: "absolute"}))
                        }
                ...
                e = (j) ? {opacity: [m, 0]} : {opacity: [m, this._o.backgroundOpacity / 100]};
        ...
        t14: function (k, l) {
            var j = this.t13(this._o.screenPadding), e = $mjs(window).j12();
            l = l || j;
            return {
        ...
        resize: function (l) {
            var m = (g.j21.touchScreen) ? {width: window.innerWidth, height: window.innerHeight} : $mjs(window).j7(),
                r = this.t22.j29("size"), n = this.t22.j29("ratio"), k = this.t22.j29("padX"), e = this.t22.j29("padY"),
                q = this.t22.j29("hspace"), j = this.t22.j29("vspace"), p = 0, o = 0;
            if (l) {
                m.width -= l.x;
                m.height -= l.y
            }
            ...
            return {width: Math.ceil(p), height: Math.ceil(o)}
        },
        ...
        z37: function (o) {
            ...
            var k = l(o).j26(), p = $mjs(k.split(";")), n = null, j = null;
        ...
        parseExOptions: function () {
            var e = null, l = this.position, k = this.size;
            for (var j in l) {
        ...
        t17: function (m, e) {
            e = e || false;
            var j = this.t15(m.group), k = j.indexOf(m) + 1;
        ...
        onKey: function (k) {
            var j = this._o.slideshowLoop, m = null;
            if (!this._o.keyboard) {
                g.doc.je2("keydown");
                return true
            }
